...
categoriesstring = "kit_datacard_ljets_j4_t3_hdecay.txt  kit_datacard_ljets_jge6_tge4_hdecay.txt  kit_datacard_ljets_j5_tge4_hdecay.txt  kit_datacard_ljets_jge6_t3_hdecay.txt  kit_datacard_ljets_j5_t3_hdecay.txt  kit_datacard_ljets_j4_t4_hdecay.txt"

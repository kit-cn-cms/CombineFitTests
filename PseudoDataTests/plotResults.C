...
void setupHistogramBin(TH1D* histo, const int& bin, const TString& binLabel, const Double_t& binContent, const Double_t& binError )
{
   ...
   const double upperBound=3)
{
  ...
  delete hPostfitBmeans;
  delete hPostfitBmedians;
